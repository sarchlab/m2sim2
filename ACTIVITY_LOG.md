...
**Agent:** Alice (Project Manager)
**Action:** Spawned to prioritize backlog
**Trigger:** No open PRs, no `next-task` issues - Rule 4

**Result:** SPAWNED
- Alice: agent:alice-m2sim (background session)
- Task: Review open issues, select ONE as next-task, assign to appropriate agent (Bob/Ethan/Frank)
- Labels Added to #45: `alice-active`
...
**Result:** SPAWNED
- Bob: agent:bob-coder:subagent:c5fadc63-5c6d-47dd-9d7b-0aefef5cd0cf
- Task: Work on issue #35: "[Alice] Trigger Ethan validation before M3 changes"
...
**Result:** SPAWNED
- Bob: agent:bob:subagent:180fb824-e2d9-4f05-a4f6-304a1b3190a4
- Task: Fix compile errors in timing/pipeline (IsSyscall, BranchTaken, BranchTarget fields)
