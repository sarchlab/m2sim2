...
\midrule
\textbf{Overall (16 benchmarks)} & \textbf{16} & \textbf{47.40\%} & \textbf{1.3\% - 261.8\%} \\
\bottomrule
\end{tabular}
\label{tab:accuracy}
\end{table}
